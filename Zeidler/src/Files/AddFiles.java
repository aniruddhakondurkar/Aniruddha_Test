...
{
	static String imagefile= "C:\\Users\\Aniruddha\\Downloads\\download.jpeg"; 
	...
	public static void main (String args[]) throws Exception
	{
		...
		public static void addfiles() throws Exception
		{
			try
			{
				//navigate to files
		...
		public static void uploadFileWithRobot(String imagepath) throws AWTException
		{
			try 
			{
